...
<html lang="es">
  ...
  <body>
    ...
    <div class="container"  id="form">
      <div class="row mt-5">
        <div class="col-12">
          <center><h1>A�adir libro</h1></center>
        </div>
      </div>
      <div class="row">
          <div class="col-2"></div>
          ...
          <div class="col-3">
              ...
              <div class="form-group input-group">
                ...
                <span class="input-group-btn">
                    ...
                    data-toggle="modal" data-target="#AgregarAutor">A�adir autor</button>
                </span>
              </div>
          </div>
      </div>
      <div class="row">
          ...
          <div class="col-6">
            <div class="form-group">
              <label for="cod-lib">C�digo libro</label>
      ...
      <div class="row">
          ...
          <div class="col-3">
              ...
              <div class="form-group input-group">
                ...
                <span class="input-group-btn">
                    <button class="btn btn-primary" type="button" 
                            data-toggle="modal" data-target="#AgregarTema">A�adir tema</button>
                </span>
              </div>
          </div>
      </div>
      <div class="row">
        <div class="col-8"></div>
        <div class="col-3">
            <button class="btn btn-secondary btn-lg " type="button" id="Cargar">A�adir</button>
        </div>
      </div>
